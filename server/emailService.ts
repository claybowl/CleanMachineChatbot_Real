...
const BUSINESS_EMAIL = 'cleanmachinetulsa@gmail.com';
...
- For best results, avoid parking directly under trees or in dusty areas before your appointment.
`;
    ...
    <div class="content">
      ...
      <div class="instructions">
        ...
        <ul>
          ...
          <li>For best results, avoid parking directly under trees or in dusty areas before your appointment.</li>
        </ul>
      </div>
      
      <p>To reschedule or cancel your appointment, please reply to this email or call us at <strong>(918) 856-5304</strong>.</p>
  ...
  <div class="container">
    ...
    <div class="content">
      ...
      <div class="options">
        ...
        <p>To reschedule: Reply to this email with "RESCHEDULE" in the subject line.</p>
        <p>To cancel: Reply to this email with "CANCEL" in the subject line.</p>
        <p>For other questions: Call us at <strong>(918) 856-5304</strong>.</p>
      </div>
