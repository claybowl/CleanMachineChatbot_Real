  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-blue-950/10 to-black text-white overflow-hidden relative">
      ...
      <div className="absolute inset-0 z-0 overflow-hidden">
        <div className="absolute top-[20%] left-[10%] w-96 h-96 bg-blue-500/5 rounded-full filter blur-3xl"></div>
        <div className="absolute bottom-[10%] right-[20%] w-64 h-64 bg-blue-600/5 rounded-full filter blur-3xl"></div>
      </div>

      <header className="relative z-20">
        <nav className="flex justify-end items-center max-w-7xl mx-auto px-4 md:px-8 py-4">
          {/* Right side navigation elements would go here */}
        </nav>
      </header>
